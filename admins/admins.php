...
<html lang="en">
    ...
    <body class="bg-light">
        ...
        <div class='modal fade' tabindex='-1' role='dialog' aria-labelledby='myLargeModalLabel' id="addAdmin" aria-hidden='true'>
            <div class='modal-dialog modal-lg'>
                <div class='modal-content'>
                    <div class='modal-header'>
                        <h5 class='modal-title' id='approveModalLabel'>Add an Admin</h5>
                    </div>
                    <div class='modal-body'>
                        <form method='post'>
                            <div class='form-group'>
                                <label for='a_name' class='col-form-label'>Name: </label>
