...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo SITE_NAME; ?> Admin | Sign In</title>
            ...
            <div class="col-12" style="height: 100vh;">
                ...
                <div class="row">
                    <div class="col-12 mt-2">
                        <img src="../assets/images/aider-logo.png" class="d-block ml-auto mr-auto p-3" style="width: auto; height: 180px;" />
                    </div>
                </div>
        ...
        <div class="toast-container">
            <?php
                if(isset($_POST['btn-login'])) {
                    ...
                    $response = $Aider->getUserModal()->getAdminModal()->loginCustomer($email, $pswd);
