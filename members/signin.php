    ...
    <body class="container-fluid bg-light">
        ...
        <div class="row">
            <div class="col-12" style="height: 100vh;">
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="../assets/images/aider-d-logo.jpg" class="d-block ml-auto mr-auto p-3" style="width: auto; height: 180px;" />
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <h6 class="text-center mt-3">New to myAider? <a href="signup.php" class="text-primary">Create an account.</a></h6>
                    </div>
                </div>
            </div>
        </div>
