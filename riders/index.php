    ...
    <body class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 bg-primary" style="height: 90vh;">
                ...
                <h1 class=" text-center text-light text-uppercase" style="font-family: 'Barlow', sans-serif;"><?php echo SITE_NAME ?> Rider</h1>

                <div class="row">
                    <div class="col-12 mt-5">
                        <h3 class="text-center mt-5 font-weight-bold text-light" style="font-family: 'Barlow', sans-serif;">BECOME AN AIDER RIDER.</h3>
